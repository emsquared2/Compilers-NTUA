...
unsigned int   quadNext;               /* Number of next quadruple       */
unsigned int   tempNumber;             /* Numbering of temporaries       */

static unsigned int   hashTableSize;   /* Size of hash table             */
...
/* ---------------------------------------------------------------------
   ------- Implementation of symbol table manipulation functions -------
   --------------------------------------------------------------------- */
...
static SymbolEntry * newEntry (const char * name)
{
    ...
    /* Initialization of all except: entryType and u */
...
void destroyEntry (SymbolEntry * e)
{
    ...
    switch (e->entryType) {
        ...
        case ENTRY_PARAMETER:
            /* Parameters are destroyed along with the function */
            return;
