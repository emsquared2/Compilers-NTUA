...
/* Procedure for printing the symbol table */
...
/* Main program demonstration of the symbol table */

/* Below is the code of a PCL program used for symbol table verification.
